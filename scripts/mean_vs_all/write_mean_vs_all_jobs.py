...
from scripts.script_helpers import generate_runs
from definitions import ROOT_DIR, HOME_DIR


def write_mean_vs_all_jobs() -> None:
  runs_dir = Path(ROOT_DIR) / 'scripts' / 'mean_vs_all'
  runs_fname = 'mean_vs_all_runs.txt'
  ...
  generate_runs(run_dict, runs_dir, runs_fname, data_dir=data_dir,
                sub_dir_keys=['features'])



if __name__ == "__main__":
  write_mean_vs_all_jobs()